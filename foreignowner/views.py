...
def foreign(request, page):
    allpage = Page.objects.all()
    page_dict = {
        'liaison-office-registration': 'Liaison Office Registration',
        'branch-office-registration': 'Branch Office Registration',
        'project-office-registration': 'Project Office Registration',
    }
